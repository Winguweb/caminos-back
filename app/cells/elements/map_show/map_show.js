CDLV.Components['map_show'] = Backbone.View.extend({
  ...
  filterFeatures: function() {
    return {
      ...
      features: this.features.features.filter(function(feature) {
        passCategoryFilter = (feature.properties.category == this.categoryFilter) || !this.categoryFilter
        passStatusFilter = (feature.properties.status == this.statusFilter) || !this.statusFilter
  ...
  showFeaturesGeometry: function() {
    var options = {
      onEachFeature: function(feature, layer) {
        layer.on({
          click: function(e) {window.location = feature.properties.url}
        })
      }
    }
