CDLV.Components['elements/floating_button'] = Backbone.View.extend({
  ...
  citizenParticipationUrl: function(filter_name){
    if(!filter_name) return `<a id="citizen-participation-add" href=/barrios/${this.neighborhoodSlug}/assets/new target=_blank>mapear</a>`

    return `<a id="citizen-participation-add" href=/barrios/${this.neighborhoodSlug}/${filter_name}/new target=_blank>${this.translateText(filter_name)}</a>`
  },
